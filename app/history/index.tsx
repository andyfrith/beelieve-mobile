...
export default function HistoryScreen() {
  const { mutate: clearAllMedications, isPending } = useClearAllMedications();
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            // try {
            //   // await clearAllData();
            //   await medicationService.clearAll();
            //   await loadHistory();
...
const styles = StyleSheet.create({
  ...
  filterButton: {
    ...
    marginRight: 10,
    borderWidth: 1,
    borderColor: Colors.honey.color4,
  },
  filterButtonActive: {
    backgroundColor: Colors.honey.color4,
    borderColor: Colors.honey.color4,
  },
  filterText: {
    fontSize: 14,
